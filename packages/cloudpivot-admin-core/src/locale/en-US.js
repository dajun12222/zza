...
import system from 'cloudpivot-admin-core/src/locale/system/system.en-US';
...
import widgets_en from 'cloudpivot-portal-designer/src/designerCore/ui-extensions/widgets/languages/en';
import uiProperty_en from '@cloudpivot-shared/ui-property-editor/src/languages/en';
import * as base_en from 'cloudpivot-portal-designer/src/designerCore/ui-extensions/languages/en';
  ...
  languages: {
    ...
    common: {
      ...
      workBenchInfo: {
        ...
        deleteTips2:
          'Are you sure you want to delete the selected {num} drafts?',
        myApplications: 'My Apps',
        tips1:
          'Users manage their own authorized applications in the foreground',
        tips5:
