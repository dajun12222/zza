...
import NodeCanvas from 'cloudpivot-admin-core/src/views/app/biz-rule/typings/node-canvas';
import TraceManager from 'cloudpivot-admin-core/src/views/app/biz-rule/typings/node-canvas-trace';
import { NodeType } from 'cloudpivot-admin-core/src/views/app/biz-rule/typings/node-type';
...
const actions = {
  ...
  async updateWorkflowDraft({ commit }: any, params: any) {
    return await bizpropertyApi.businessruleUpdata(params);
  },
