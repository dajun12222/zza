...
import TraceManager from 'cloudpivot-admin-core/src/common/workflow/workflowTrace';
import WorkflowManager from 'cloudpivot-admin-core/src/common/workflow/workflowManager';
import WorkflowApi from 'cloudpivot-admin-core/src/apis/workflow';
import AppItem from 'cloudpivot-admin-core/src/apis/apps';

import { list } from 'cloudpivot-admin-core/src/apis/form/form.api';
...
const mutations = {
  ...
  dataToProps(state: any, type?: string) {
    ...
    const _object: any = {
      ...
      activitySenior: {
        ...
        timeoutNotifyStrategies: _curActivity.timeoutNotifyStrategies,
        timeoutNotifyTypes: _curActivity.timeoutNotifyTypes,
        timeoutWarning1: _curActivity.timeoutWarning1,
        timeoutWarning1NotifyStrategies:
          _curActivity.timeoutWarning1NotifyStrategies,
        timeoutWarning2: _curActivity.timeoutWarning2,
        timeoutWarning2NotifyStrategies:
          _curActivity.timeoutWarning2NotifyStrategies,
        timeoutWarning3: _curActivity.timeoutWarning3,
        timeoutWarning3NotifyStrategies:
          _curActivity.timeoutWarning3NotifyStrategies,
        timeoutWarning4: _curActivity.timeoutWarning4,
        timeoutWarning4NotifyStrategies:
          _curActivity.timeoutWarning4NotifyStrategies,
        timeoutWarning5: _curActivity.timeoutWarning5,
        timeoutWarning5NotifyStrategies:
          _curActivity.timeoutWarning5NotifyStrategies,
      ...
      templateList: _curActivity.templateList,
      settingPrint: _curActivity.settingPrint,
      printBindType: _curActivity.printBindType,
    };
  ...
  propsToData(state: any) {
    ...
    if (_index !== -1) {
      ...
      const templateList = state.curActivityProps.templateList;
      const settingPrint = state.curActivityProps.settingPrint;
      const printBindType = state.curActivityProps.printBindType;
  ...
  //设置流程超时配置信息
  setTimeoutConfig(state: any, value) {
    state.workflowData.timeoutConfig = value;
  },
