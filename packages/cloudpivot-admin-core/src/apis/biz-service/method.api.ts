...
export default {
  ...
  deleteMethod(
    ...
    return axios.post(`/api/bizservice/method/delete?${Params.join('&')}`);
  },
  /**
   * 更新服务方法
   * @param params
  ...
  updateMethod(
    ...
    return axios.post('/api/bizservice/method/update', params);
  },
  /**
   * 获取服务方法详情
   * @param params
  ...
  testMethod(params: BizService.Method.TestParams): Promise<Common.Response> {
    return axios.post('/api/bizservice/method/service_test', params);
  },
  /**
   * 列出参数应用位置选项
   */
  ...
  updateDatasourceMethods(
    ...
    return axios.post('/api/bizdatasource/method/update', params);
  },
  deleteDatasourceMethods(
    ...
    return axios.post(`/api/bizdatasource/method/delete?${Params.join('&')}`);
  },
  ...
  serviceTestDatasourceMethods(params): Promise<Common.Data> {
    return axios.post('/api/bizdatasource/method/service_test', params);
  },
};
