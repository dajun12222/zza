...
export default {
  ...
  deleteWorkflow(params: Apps.Workflow.WorkflowCode): Promise<Common.Data> {
    ...
    return Axios.post(`/api/workflow/delete?${Params.join('&')}`);
  },

  updateWorkflow(
    params: Apps.Workflow.CreateWorkflowParams,
  ): Promise<Common.Data> {
    return Axios.post('/api/workflow/update_header', params);
  },
  ...
  updateWorkflowDraft(params: any): Promise<Common.Data> {
    return Axios.post('/api/workflow/update', params);
  },
  ...
  deletePermission(
    ...
    return Axios.post(`/api/workflow/delete_permission?${Params.join('&')}`);
  },
  //获取流程模板历史列表
  getHistoryList(
    params: Apps.WorkflowSetting.GetPermissionListParams,
