...
export default {
  ...
  updateDataItem(params: Apps.Datamodel.DataItem): Promise<Common.Response> {
    // 更新数据项
    return Axios.post('/api/app/bizproperty/update', params);
  },
  ...
  deleteDataItem(
    ...
    return Axios.post(`/api/app/bizproperty/delete?${Params.join('&')}`);
  },
  forceDeleteDataItem(
    params: Apps.Datamodel.DeleteParams,
  ): Promise<Common.Response> {
    ...
    return Axios.post(`/api/app/bizproperty/force_delete?${Params.join('&')}`);
  },
  publishDataItem(
    params: Apps.Datamodel.PublishParams,
  ): Promise<Common.Response> {
    // 数据项发布
    return Axios.post('/api/app/bizproperty/publish', params);
  },
  getBizmodeltitle(
    params: Apps.Datamodel.DataItemListParams,
  ): Promise<Common.Response> {
  ...
  /* 获取应用中心首页列表 */
  getAppList(params?: any): Promise<Common.Response> {
    return Axios.get('/api/app/apppackage/list', { params });
  },
  /* 新增应用 */
  ...
  deleteAppPackage(params: Apps.AppCenter.AppInfoParams): Promise<Common.Data> {
    ...
    return Axios.post(`/api/app/apppackage/logical_delete?${Params.join('&')}`);
  },
  /* 更新应用排序 */
  updateAppSort(params: Apps.AppCenter.AppSortParams): Promise<Common.Data> {
    return Axios.post('/api/app/apppackage/sortkeys', params);
  },
  /* 查询单个应用的详情 */
  ...
  updateAppFolder(params: Apps.AppItem.UpdateFolders): Promise<Common.Data> {
    return Axios.post('/api/app/folders/update', params);
  },
  /* 删除目录 */
  deleteAppFolder(params: Apps.AppItem.DeleteFolders): Promise<Common.Data> {
    ...
    return Axios.post(`/api/app/folders/delete?${Params.join('&')}`);
  },
  /* 校验目录节点下是否存在业务模型 */
  ...
  updateAppModel(params: Apps.AppItem.UpdateBizModel): Promise<Common.Data> {
    return Axios.post('/api/app/bizmodels/update', params);
  },
  /* 删除模型 */
  deleteAppModel(params: Apps.AppItem.DeleteBizModel): Promise<Common.Data> {
    ...
    return Axios.post(`/api/app/bizmodels/logical_delete?${Params.join('&')}`);
  },
  /* 校验业务模型节点下是否存在业务数据 */
  ...
  appItemSort(params: Apps.AppItem.AppItemSortParams): Promise<Common.Data> {
    return Axios.post('/api/app/apppackage/appfuncsortkeys', params);
  },
  /* 加载当前应用下的目录 */
  ...
  submitSummary(
    ...
    return Axios.post('/api/app/bizmodels/update_summary', params);
  },
  fileUploadUrl,
  fileUploadUrl2,
  ...
  deleteDefinePage(params: Apps.AppCenter.DefinePage): Promise<Common.Data> {
    ...
    return Axios.post(`/api/custom/logical_delete?${Params.join('&')}`);
  },
  ...
  deleteAppReport(params: Apps.AppItem.DeleteReport): Promise<Common.Data> {
    ...
    return Axios.post(`/api/report/logical_delete?${Params.join('&')}`);
  },
  /* 查询报表模型图表 */
  queryReportChartTree(): Promise<Common.Data> {
    return Axios.post('/api/app/folders/queryReportChartTree', {});
  },
  ...
  RecycleDelete(params: any): Promise<Common.Data> {
    return Axios.post('/api/app/apppackage/physically_delete', params);
  },
  ...
  AppgroupUpdate(params: any): Promise<Common.Data> {
    return Axios.post('/api/app/appgroup/update', params);
  },
  /**
   * 删除应用分组接口
   * @param {Object} params
  ...
  AppgroupDelete(params: any): Promise<Common.Data> {
    ...
    return Axios.post(`/api/app/appgroup/delete?${Params.join('&')}`);
  },
  /**
   * 清空所有回收站
   * @returns
  ...
  physically_deleteAll(): Promise<Common.Data> {
    return Axios.post('/api/app/apppackage/physically_deleteAll');
  },
  /**
   * 还原所有回收站
   * @returns
