...
export default {
  ...
  updateUserOuscope(
    ...
    return Axios.post('/api/organization/role/update_ouscope', params);
  },
  ...
  updateOrgan(
    ...
    return Axios.post('/api/system/relatedcorp/update', params);
  },
  ...
  deleteCheck(params: any): Promise<Common.Response> {
    ...
    return Axios.post(
      `/api/system/relatedcorp/delete_check?${Params.join('&')}`,
    );
  },
  ...
  deleteOrgan(params: any): Promise<Common.Response> {
    ...
    return Axios.post(`/api/system/relatedcorp/delete?${Params.join('&')}`);
  },
  ...
  deleteSmsTemplate(params: any): Promise<Common.Response> {
    ...
    return Axios.post(`/api/system/sms/delete?${Params.join('&')}`);
  },
  // 短信通知：获取未发送短信列表
  ...
  updateRoleGroup(params: Organization.roleGroupParams): Promise<Common.Data> {
    return Axios.post('/api/organization/role/modify_role_group', params);
  },

  // 更新角色
  updateRole(params: Organization.roleParams): Promise<Common.Data> {
    return Axios.post('/api/organization/role/modify_role', params);
  },
...
export const updateMainDepartment = (
  ...
  return Axios.post('/api/organization/user/update_main', params);
};
// 导入部门
...
export const deleteUserExt = (
  ...
  return Axios.post(`/api/organization/user/ext/delete?${Params.join('&')}`);
};
