      ...
      >
        ...
        >
          <img
            v-if="isPrevDisabled"
            class="disabled"
            src="~cloudpivot-admin-core/src/assets/images/arrow-disabled.png"
          />
          <img
            v-else
            src="~cloudpivot-admin-core/src/assets/images/arrow.png"
            alt=""
          />
        </div>
        ...
        <div class="guide-img">
          <img
            src="~cloudpivot-admin-core/src/assets/images/guide1.png"
            alt=""
          />
        </div>
        <div class="guide-img">
          <img
            src="~cloudpivot-admin-core/src/assets/images/guide2.png"
            alt=""
          />
        </div>
        <div class="guide-img">
          <img
            src="~cloudpivot-admin-core/src/assets/images/guide3.png"
            alt=""
          />
        </div>
        <div class="guide-img">
          <img
            src="~cloudpivot-admin-core/src/assets/images/guide4.png"
            alt=""
          />
        </div>
        <div class="guide-img">
          <img
            src="~cloudpivot-admin-core/src/assets/images/guide5.png"
            alt=""
          />
        </div>
