...
type FormControlTypes =
  | schema.FormControlTypeMain
  | schema.FormControlTypeExtend;

// eslint-disable-next-line @typescript-eslint/no-redeclare
const {
  FormControlType,
  DataItemType,
  IsFullRowFormControlList,
  NotDataItemOfFormControlList,
  NoKeyAttributeFormControlList,
} = schema;
...
export function buildControl(block: any): FormControl {
  ...
  if (NoKeyAttributeFormControlList.includes(block.type)) {
    key = createKey(block.type);
  }
...
export function createKey(type: FormControlTypes) {
...
export function buildControlOptions(
  ...
  if (
    ...
    ].includes(controlType as schema.FormControlTypeMain)
  ) {
    if (options.labels) {
...
export function notDataItemOf(controlType: FormControlTypes) {
  ...
  // );
  return NotDataItemOfFormControlList.includes(controlType);
}
...
export function isFullRow(controlType: FormControlTypes) {
  ...
  // );
  return IsFullRowFormControlList.includes(controlType);
}
