...
import { OperatorService } from 'cloudpivot-admin-core/src/components/shared/data-item/data-item4';
import DataitemMapping, {
  DataitemMappingValueItem,
  DataitemSource,
} from 'cloudpivot-admin-core/src/components/shared/data-item/dataitem-mapping2.vue';
import { Modal } from '@h3/antd-vue';
import { convertDataItemExp, DataItemType } from 'cloudpivot-form/form/schema';
