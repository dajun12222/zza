  ...
  <div class="base-info">
    <div class="base-info-header">
      ...
      <a-tooltip placement="top">
        ...
        <i
          class="icon aufontAll h-icon-all-resumption-applicati"
          @click="goHistoryWorkflow"
        ></i>
      </a-tooltip>
    </div>
    <div class="base-info-content">
      ...
      <a-row class="base-info-content__row">
        ...
        <a-col :span="10"><span>{{
            baseInfo.runMode === 'AUTO' ? '自动运行' : '手动运行'
          }}</span></a-col>
      </a-row>
    </div>
  </div>
...
<script lang="ts">
import { Col, Row, Tooltip } from '@h3/antd-vue';
...
export default class BaseInfo extends Vue {
  ...
  get finishTime() {
    return this.baseInfo.status === 'CANCELED'
      ? this.baseInfo.cancelTime
      : this.baseInfo.finishTime;
  }
