  ...
  return {
    ...
    _papersize: Object.assign(
      ...
      PaperSpecItem.filter(
        (item: PaperSpecSize) => item.scale === PaperSpecName.A4,
      )[0],
    ),
    _pagemargin: Object.assign({}, DefaultMargin),
    _headerfooter: {
      header: getDefaultHeaderFooter(),
      footer: getDefaultHeaderFooter(),
    },
    bgImg: {
      uid: '',
      name: '',
