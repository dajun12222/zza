...
<script lang="ts">
import { PrintNodeSettings } from 'cloudpivot-admin-core/src/config/print/dataStructure';
...
export default class PreView extends Vue {
  ...
  imgObj: any = {
    qr_code: require('cloudpivot-admin-core/src/assets/images/qrcode.png'),
    bar_code: require('cloudpivot-admin-core/src/assets/images/barcode.png'),
    pic_img: require('cloudpivot-admin-core/src/assets/images/pic.png'),
  };
