          ...
          <div class="license-content">
            <div class="license-form">
              ...
              <div class="info-title">
                系统授权/许可证
                <updataLicense
                  v-if="licenseInfo.verifyMode === 'offline'"
                  @uploadLicenseSuccess="getLicenseInfo('updataLicenseSuc')"
                />
              </div>
              <a-row class="license-item">
                <a-col :span="layout.left" class="license-left">
...
import updataLicense from './updataLicense.vue';
import {
  Tabs,
  Row,
  Col,
...
export default class License extends Vue {
  ...
  getLicenseInfo(type?: string) {
    if (type === 'updataLicenseSuc') {
      EventBus.$emit('updataLicenseSuc');
    }
