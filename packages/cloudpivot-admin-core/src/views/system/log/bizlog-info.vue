  ...
  <div class="bizlog-info">
    <div class="bizlog-info__content">
      ...
      <div class="bizlog-info__card">
        ...
        <a-row class="bizlog-info__item" type="flex" justify="start">
...
export default class BizlogDetails extends Vue {
  ...
  argument: string =
    '<BizStructure> <Item> <ItemName>days</ItemName> <ItemValue> <double>500</double> </ItemValue> </Item> </BizStructure>';

  returnVal: string =
    '<BizStructure> <Item> <ItemName>shenpi</ItemName> <ItemValue> <ArrayOfString xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"> <string>e6a4bed8-05bf-4748-8564-f39433db3915</string> </ArrayOfString> </ItemValue> </Item> </BizStructure>';
