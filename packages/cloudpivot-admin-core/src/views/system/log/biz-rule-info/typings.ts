...
export const columns: Array<Icolumn> = [
  ...
  },
  {
    ...
    slots: { title: 'bizRuleName' },
    scopedSlots: { customRender: 'businessRuleName' },
    width: '10%',
    key: 'businessRuleName',
    align: Ealign.left,
  },
  {
    dataIndex: 'businessRuleCode',
    slots: { title: 'bizRuleCode' },
    scopedSlots: { customRender: 'businessRuleCode' },
    width: '10%',
    key: 'businessRuleCode',
    align: Ealign.left,
  },
  {
    dataIndex: 'state',
    slots: { title: 'executState' },
  ...
  },
  {
    ...
    slots: { title: 'exceptionNode' },
    scopedSlots: { customRender: 'exceptionNodeName' },
    width: '10%',
