...
import BaseInfo from 'cloudpivot-admin-core/src/components/global/workflow-mock/base-info.vue';
import flow from 'cloudpivot-flow/flow/pc';
import ChartCard from 'cloudpivot-admin-core/src/components/shared/chart-card';
import PortalChartCard from 'cloudpivot-flow/flow/src/components/pc/chart-card';
import RejectModal from 'cloudpivot-admin-core/src/components/global/workflow-mock/modals/reject-modal.vue';
...
<style lang="less">
@import '~cloudpivot-flow/flow/src/components/style.less';
.detail-delete-icon {
