...
<script lang="ts">
import MessageReminderApis from 'cloudpivot-admin-core/src/apis/message-reminder/index.api';
import DataTitle from 'cloudpivot-admin-core/src/components/global/data-title.vue';
import { OperatorService } from 'cloudpivot-admin-core/src/components/shared/data-item/data-item';
import DataitemCondition from 'cloudpivot-admin-core/src/components/shared/data-item/dataitem-condition3.vue';
import RoleTree from 'cloudpivot-admin-core/src/components/shared/user/role-tree.vue';
import {
  Col,
  Icon,
  Input,
