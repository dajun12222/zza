...
import {
  ignore_file_types_extends,
  allow_file_types_extends,
  image_types_extends,
  doc_types_extends,
} from 'extension-template/src/common/controls/upload-control-config';
...
const ignore_file_types = [
  ...
  '.swf',
  '.exe',
].concat(ignore_file_types_extends);
...
const allow_file_types = [
  ...
  '.ceb',
  '.cebx',
].concat(allow_file_types_extends);
