...
<template>
  <div class="h3-organization" :class="prefixCls" :style="prefixStyle">
    ...
    >
      ...
      <!-- 展示所有列表信息 -->
      <div
        v-if="!visiblePart && !propVisiblePart"
        class="h3-organization-wrapper"
      >
            ...
            <div class="h3-organization-selected">
              <div class="selected-item">
                ...
                <template v-if="!checkExist(o.id)">
                  <span v-show="!disabled" class="close-icon-wrapper">
                    <em
    ...
    >
      ...
      <div v-if="hasValue" class="plus-wrapper">
        <div v-if="!disabled" class="plus-icon" @click="focus">
