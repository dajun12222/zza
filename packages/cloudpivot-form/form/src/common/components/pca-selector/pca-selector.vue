...
export default class PcaSelector extends Vue {
  ...
  getPcaBaseData() {
    if (!this.pvcs || this.pvcs.length === 0) {
      ...
      return import(
        /* webpackChunkName: "pca" */ 'cloudpivot/common/src/pca/pca.min'
      ).then((mod) => {
