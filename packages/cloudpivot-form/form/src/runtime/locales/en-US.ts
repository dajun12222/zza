...
export default {
  action: {
    ...
    [FormAction.Cancel]: 'Cancel-workflow',
    ...
    [FormAction.AssistRetrieve]: 'RetrieveAssist',
    [FormAction.InitiateGroupChat]: 'InitiateGroupChat',
    more: 'More',
    save2: 'Save',
    cancel2: 'Cancel',
    copy: 'Copy',
  ...
  actionTip: {
    ...
    [FormAction.Cancel]: 'CancelInstance succeeded!!',
  ...
  tip: {
    ...
    notRepeat: '[{ctrl}] cannot repeat',
    errTips22:
      'Please wait for the calculation rule to  execution to complete!',
    errTips23: 'Please wait for data linkage execution to complete!',
    errTips24: 'Please input your opinion',
    errTips25: 'Please upload the attachment',
    errTips26: 'Please scan the code and sign',
    errTips27: 'The opinion cannot be blank！',
    errTips28: 'The maximum commonly used opinions is 10',
    successTips: 'Data successfully saved',
    successTips2: 'Saving succeeded',
    successTips3: 'Workflow initiated successfully',
    successTips4: 'Task submitted successfully',
    successTips5: 'Add succeeded!',
    successTips6: 'Delete success',
  },
  ...
  urge: {
    ...
    defaultUrgeContent: 'Please handle [{obj}] as soon as possible',
    defalutUrgeContent1: 'Please handle as soon as possible',
  },
};
