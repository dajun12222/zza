...
<script lang="ts">
import { formApi, dictionaryApi } from 'cloudpivot/api';
import H3Textarea from 'cloudpivot-form/form/src/common/components/h3-textarea.vue';
  ...
  created() {
    ...
    if (
      ...
      try {
        ...
        this.dictionaryCode = options.checkedDictionaryCode || '';
