...
<template>
  <div class="search-panel">
    <div v-show="showState" class="search-panel__header">
      <div class="search-bar">
        <!-- 单据状态 -->
        <div
          class="form-states"
          :class="{ tree: showStyle === 'tree' && relevanceId === 'parentId' }"
        >
          <div
    ...
    >
      ...
      <div v-show="fetched && total <= 0" class="no-result">
        <div>
          <img src="./no-data.png" />
          {{ $t('cloudpivot.form.renderer.noData') }}
        </div>
...
import { Segment } from 'cloudpivot-form/form/src/common/controls';
import H3Scroll from 'cloudpivot-form/form/src/renderer/components/layout/h3-mescroll.vue';
