...
若有问题，请参考前端相关二开文档。
*/
import mobileListTemplate from 'cloudpivot-list/list/src/components/listCustom/template/mobile/handler';
import pcListTemplate from 'cloudpivot-list/list/src/components/listCustom/template/pc/handler';
...
export class ListHtmlGenerator {
  ...
  private generateScriptVersionLogs(version) {
    const handler =
      ...
      (this.listEventHooksHandler =
        require('cloudpivot-list/list/src/components/listCustom/eventHooks/handler').default);
