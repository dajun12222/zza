...
<template>
  <div id="mobile-formlist-container" ref="application" class="form-list">
    ...
    <div class="home-router">
      <router-view />
      <div v-if="canAdd && schemaCode !== 'onlineLearning' && schemaCode !== 'onlineExam' && schemaCode !== 'onlineCourseExam' && schemaCode !== 'analysis'" class="home-router-add" @click="goForm">
        <img src="./add.png" />
      </div>
    </div>
  </div>
...
import { dateFormatter } from 'cloudpivot-form/form/src/renderer/utils';
...
import returnTemplate from '../../../../../../mobile/extends/components/return/index.vue';
import analysisExam from '../../../../../../mobile/extends/views/onlineExam/index/analysisExam.vue';
...
export default class FormList extends Vue {
  ...
  setKnowledgeType(val:any){
    this.knowledgeType = val;
    this.getOnlineLearnlist(val,'')
  }

  setCourseName(val:any){
    this.getOnlineLearnlist(this.knowledgeType,val)
  }
  ...
  getOnlineLearnlist(knowledgeType:any, courseName:any){
    const vm: any = this;
    listApi
      .getOnlineLearnlist({
        page:1,
