...
若有问题，请参考前端相关二开文档。
*/
import * as WorkflowCenter from 'cloudpivot-list/list/src/typings/workflow-center';
...
import * as numberFormatter1 from 'cloudpivot-form/form/utils/number-formatter';
