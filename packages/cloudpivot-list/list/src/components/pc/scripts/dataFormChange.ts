...
若有问题，请参考前端相关二开文档。
*/
import { components, UploadStatus } from 'cloudpivot-form/form/renderer';
import {
  FormControlType,
  RendererFormControl,
  DropdownOptions,
...
import { RendererControl } from 'cloudpivot-form/form/src/renderer/typings';
import * as renderer from 'cloudpivot-form/form/renderer';
