...
let __flash__argumentsToXML = window.__flash__argumentsToXML || (() => {});
let SWFUpload = window.SWFUpload || function () {};
    ...
    try {
      ...
      if (this.movieElement && typeof movieElement.CallFunction === 'unknown') {
        ...
        for (var key in movieElement) {
          if (movieElement.hasOwnProperty(key)) {
            try {
