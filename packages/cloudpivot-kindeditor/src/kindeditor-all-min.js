...
const __flash__argumentsToXML = window.__flash__argumentsToXML || (() => {});
...
!(function (window, undefined) {
  ...
  function _moveToElementText(a, b) {
    for (var c = b; c; ) {
      var d = K(c);
      if ('marquee' == d.name || 'select' == d.name) {
        return;
      }
      c = c.parentNode;
    }
  ...
  function _loadStyle(a) {
    for (
      ...
      if (_chopQuery(_formatUrl(e[f].href, 'absolute')) === d) {
        return;
      }
  ...
  (function (a) {
    ...
    a.extend(b, {
      ...
      appendFile: function (b) {
        var c = this,
          d = a(
            '<div class="ke-inline-block ke-item" data-id="' +
              b.id +
              '"></div>',
          );
        c.bodyDiv.append(d);
