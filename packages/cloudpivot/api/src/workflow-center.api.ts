...
export class WorkflowCenterApi {
  ...
  deleteFavoriteWorkflow(
    ...
    return Axios.post(
      `${Mappings.workflow.deleteFavoriteWorkflow}?${Params.join('&')}`,
    );
  }
  ...
  deleteWorkflowTrust(
    ...
    return Axios.post(
      `${Mappings.workflow.deleteWorkflowTrust}?${Params.join('&')}`,
    );
  }
  ...
  deleteCanceledWorkflowInstances(
    ...
    return Axios.post(
      Mappings.workflow.deleteCanceledWorkflowInstances,
      params,
    );
  }
  ...
  deleteCommonComment(params: any): Promise<HttpResponse<any>> {
    ...
    return Axios.post(
      `${Mappings.workflow.deleteCommonComment}?${Params.join('&')}`,
    );
  }
