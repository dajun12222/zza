...
export class FormApi {
  ...
  updateSortkey(params: form.UpdateSortkeyParams): Promise<HttpResponse<any>> {
    return axios.post(api.form.updateSortkey, params);
  }
  ...
  createChatGroup(params: any): Promise<HttpResponse<any>> {
    return axios.post(`/api/organization/user/ext/createChatGroup`, params);
  }
}
