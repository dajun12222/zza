...
import { Modal,Button,Spin,Table,Input,Switch } from "@h3/antd-vue";
...
export default class showData extends Vue {
    ...
    getParams(option:any,index:number){
        ...
        console.log(option);
        if(option){
            obj['shorttext1663123660655'] = option && option[0] && option[0]['name'] || '';
            obj['shorttext1663123660656'] = option && option[1] && option[1]['name'] || '';
            obj['shorttext1663123660657'] = option && option[2] && option[2]['name'] || '';
        }else{
    ...
    async getList(){
        ...
        if(res.errcode === 0){
            ...
            data.map((item:any) => {
                ...
                item['shorttext'] = [item['shorttext1663123660657'],item['shorttext1663123660656'],item['shorttext1663123660655']];
            })
