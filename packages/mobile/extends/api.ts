...
export default {
  ...
  queryQuestionTypeList(params?: any) {
    //
    return axios.get('/api/transfer/data-dictionary/queryQuestionTypeList', {
      params,
    });
  },
  ...
  getWorkItemCheckUserId(params?: any) {
    return axios.get('/api/user/exit/getWorkItemCheckUserId?' + params);
  },
  ...
  similar(problemCode?: any) {
    // return axios.post(`/api/transfer/audit-question/similar`,problemCode);
    return axios.request({
      method: 'POST',
      url: `/api/transfer/audit-question/similar/${problemCode}`,
      // headers: {
      //   'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
      // },
      // data: qs.stringify(problemCode),
    });
  },
  ...
  search(params: any, page?: any) {
    return axios.post('/api/transfer/audit-question/search?' + page, params);
  },
  ...
  caseFilePagingQuery(params: any, page?: any) {
    return axios.post(
      '/api/transfer/auditCase/caseFilePagingQuery?' + page,
      params,
    );
  },
  basicPagingQuery(params: any, page?: any) {
    return axios.post(
      '/api/transfer/auditCase/basicPagingQuery?' + page,
      params,
    );
  },
  dataResourceCounts() {
  ...
  searchDictionaryRecord(params: any,) {
    return axios.get(
